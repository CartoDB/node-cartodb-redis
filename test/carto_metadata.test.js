...
describe('metadata', function () {
    it('can retrieve database name for username', function (done) {
    ...
    it('can retrieve database host for username', function (done) {
    ...
    it('can retrieve database password for username', function (done) {
    ...
    it('retrieve id for username', function (done) {
    ...
    it('can retrieve table privacy for public table', function (done) {
    ...
    it('can retrieve table privacy for private table', function (done) {
    ...
    it('can retrieve table geometry type from username and tablename for public table', function (done) {
    ...
    it('can retrieve table geometry type from username and tablename for private table', function (done) {
    ...
    it('can retrieve map key', function (done) {
    ...
    it('retrieves sync slaves if they exist', function (done) {
    ...
    it('retrieves empty if there are no sync slaves', function (done) {
    ...
    it('retrieves async slaves if they exist', function (done) {
    ...
    it('retrieves empty if there are no async slaves', function (done) {
    ...
    it('can retrieve database connection params for username', function (done) {
    ...
    it('fails to retrieve database connection params for invalid user', function (done) {
    ...
    it('can retrieve all db params for username', function (done) {
    ...
    it('can retrieve oauth values for given oauth key', function (done) {
    ...
    it('invalid oauth keys returns empty object instead of null value', function (done) {
    ...
    it('incMapviewCount increments tree counters', function (done) {
    ...
    it('can retrieve user timeout limit for public role and it is a number', function (done) {
    ...
    getMapViewKeyMonths.forEach(function (month) {
        getMapViewKeyDays.forEach(function (day) {
            it('getMapViewKey format, month=' + month + '; day=' + day, function () {
    ...
    it('should get an API key', function (done) {
    ...
    it('should get an user master API key', function (done) {
    ...
    it('should return empty API key if it does not exist', function (done) {
